...
const PostPage: React.FC = () => {
  ...
  async function handleSubmit(): Promise<void> {
    ...
    const createResponse = await fetch(`${BASE_API_URL}/posts/create`, {
      method: "POST",
      headers: {
    ...
    if (!createResponse.ok) {
      console.error("Error creating post: ", createResponse.statusText);
      return;
    }
  ...
  return (
    <div
      ...
      style={{ paddingBottom: "80px", border: "none" }}
    >
      <Card
        style={{
          width: "100%",
